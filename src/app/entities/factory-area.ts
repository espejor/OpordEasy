...
export class AreaFactory<GeomType extends Geometry = Geometry>  extends EntityFactory{  
  ...
  createEntity(lineOptions:AreaOptions,coordinates:Coordinate|Coordinate[],id?:string ):Entity{
    var coords:Coordinate[][] = [];
    coords[0] = <Coordinate[]>coordinates 
    return new EntityArea(lineOptions,{geometry: new Polygon(coords)},id);
  }
